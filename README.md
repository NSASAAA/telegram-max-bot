...
- Открывает полные статьи на внутренней веб-странице проекта через кнопку `Читать`.
...
Полные статьи открываются на внутренних страницах проекта:
...
- Веб-читатель пока MVP: простая HTML-страница без полноценной Telegram Mini App-авторизации.
- Для комфортного открытия внутри Telegram в production нужен домен и HTTPS.
...
- Подключить домен и HTTPS для веб-читателя.
